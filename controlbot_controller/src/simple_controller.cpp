#include "controlbot_controller/simple_controller.hpp"
...
SimpleController::SimpleController(const std::string& name)
                                  ...
                                  , theta_(0.0)
{
    declare_parameter("wheel_radius", 0.056);
    declare_parameter("wheel_separation", 0.266);
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/controlbot_controller/cmd_vel", 10, std::bind(&SimpleController::velCallback, this, _1));
    ...
    odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/controlbot_controller/odom", 10);
