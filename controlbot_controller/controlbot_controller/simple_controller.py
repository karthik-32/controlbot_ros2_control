...
class SimpleController(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("wheel_separation", 0.266)
        ...
        self.vel_sub_ = self.create_subscription(TwistStamped, "controlbot_controller/cmd_vel", self.velCallback, 10)
        self.joint_sub_ = self.create_subscription(JointState,"joint_states", self.jointCallback, 10)        
        self.odom_pub_ = self.create_publisher(Odometry, "controlbot_controller/odom", 10)
