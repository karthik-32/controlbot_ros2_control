...
#include "controlbot_planning/dijkstra_planner.hpp"

namespace controlbot_planning
{
...
PLUGINLIB_EXPORT_CLASS(controlbot_planning::DijkstraPlanner, nav2_core::GlobalPlanner)