...
#include "controlbot_motion/pd_motion_planner.hpp"

namespace controlbot_motion
{
...
PLUGINLIB_EXPORT_CLASS(controlbot_motion::PDMotionPlanner, nav2_core::Controller)